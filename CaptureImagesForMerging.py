...
def mergeDirCheck(MergeImageDir):
    ...
    if os.path.isdir(MergeImageDir):
        print(MergeImageDir + ' Directory exists! - Deleting Folder and its contents')
        shutil.rmtree(MergeImageDir)

    os.mkdir(MergeImageDir)
    print("Creating a new folder to store images for Merging " + MergeImageDir +" \n")
